...
class _SignUpScreenState extends State<SignUpScreen> { 
  ...
  @override 
  void dispose() { 
    _nameCtrl.dispose(); _emailCtrl.dispose(); _passwordCtrl.dispose(); super.dispose(); 
  } 
 
  Future<void> _submit() async { 
    if (!_formKey.currentState!.validate()) return; 
    setState(() => _error = null); 
    final ok = await context.read<AuthService>().signUp( 
                ...
                child: Form( 
                  ...
                  child: Column( 
                    ...
                    children: [ 
                      ...
                      Text('Start your wellness journey with ZenU.', 
                      ...
                      SizedBox( 
                        ...
                        child: ElevatedButton( 
                          ...
                          child: auth.isLoading 
                            ...
                            : Text('Sign Up', style: GoogleFonts.inter(fontWeight: FontWeight.w600, 
fontSize: 15)), 
                        ), 
